...
public class GamePlay {
    ...
    public void playGame() throws Exception{
        ...
        System.out.println("Enter number of players maximum 4 and atleast 2");
        ...
        if (numOfPlayers < 2 || numOfPlayers > 4) {
            throw new Exception("Invalid number of players ... Enter again....");
        }
        ...
        while (true) {
            ...
            System.out.println("Discarding deck top card = " + discardPile.get(discardPile.size() - 1));
            ...
            for (Card currentPlayerCard : players.get(playerTurn).giveCards()) {
                ...
                if (currentPlayerCard.getNumber() == topDiscardCard.getNumber() || currentPlayerCard.getSuit() == topDiscardCard.getSuit()) {
                    ...
                    System.out.println("Cards matched for the player " + players.get(playerTurn).giveId() + " Card and new Discarded Deck top card = " + currentPlayerCard);
            ...
            if (matched == false) {
                System.out.println("No cards matched for player " + players.get(playerTurn).giveId() + " Taking " + numCardsTake + " Card(s)");
            ...
            if (matched == true && players.get(playerTurn).giveCards().size() == 0) {
                ...
                System.out.println("Congratulations player " + players.get(playerTurn).giveId() + ", you won the match !!!");
